  ...
  const users: User[] = [
    {
      id: 'user-admin-1',
      studentId: 'ADMIN-001',
      name: 'Dr. Shahriar Hossain (Dept Head & Admin)',
      email: 'admin@swe.edu',
      phone: '+8801700000000',
      role: 'ADMIN',
      currentSemester: 0,
    ...
    {
      id: 'user-cr-1',
      studentId: '252-134-001',
      name: 'Mahmudul Hasan (CR - 9th Batch)',
      email: 'cr9@swe.edu',
      phone: '+8801711112222',
      role: 'CR',
      batchId: 'batch-9',
    ...
    {
      id: 'user-cr-2',
      studentId: '252-134-002',
      name: 'Saima Akter (CR - 8th Batch)',
      email: 'cr8@swe.edu',
      phone: '+8801733334444',
      role: 'CR',
      batchId: 'batch-8',
      batchName: 'SWE 8th Batch',
      currentSemester: 7,
    ...
    {
      id: 'user-student-1',
      studentId: '252-134-022',
      name: 'Rashedul Hasan',
      email: 'rashedul@swe.edu',
      phone: '+8801812345678',
      role: 'STUDENT',
      batchId: 'batch-9',
      batchName: 'SWE 9th Batch',
    ...
    },
    {
      ...
      batchName: 'SWE 9th Batch',
      currentSemester: 5,
      profileImage: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=300',
      status: 'ACTIVE',
      points: 65,
    ...
    {
      id: 'user-student-3',
      studentId: '252-134-088',
      name: 'Tanvir Ahmed',
      email: 'tanvir@swe.edu',
      phone: '+8801755556666',
      role: 'STUDENT',
      batchId: 'batch-8',
      batchName: 'SWE 8th Batch',
      ...
      updatedAt: '2022-02-10T00:00:00Z',
    },
  ];

  const passwords: Record<string, string> = {
    'user-admin-1': defaultPasswordHash,
    'user-cr-1': defaultPasswordHash,
    'user-cr-2': defaultPasswordHash,
    'user-student-1': defaultPasswordHash,
    'user-student-2': defaultPasswordHash,
    'user-student-3': defaultPasswordHash,
  };
